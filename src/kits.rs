...
fn kit_808_clean() -> DrumParams {
    DrumParams {
        ...
        hat_closed: DrumSlotParams::from_values(0.65, -0.1, 0.85, 70.0, 0.50, 0.0, 0.10),
...
fn kit_edm_punch() -> DrumParams {
    DrumParams {
        ...
        hat_closed: DrumSlotParams::from_values(0.75, -0.2, 0.90, 90.0, 0.60, 0.0, 0.10),
...
fn kit_minimal_tech() -> DrumParams {
    DrumParams {
        ...
        hat_closed: DrumSlotParams::from_values(0.65, -0.2, 0.75, 70.0, 0.50, 0.0, 0.10),
...
fn kit_lofi() -> DrumParams {
    DrumParams {
        ...
        hat_closed: DrumSlotParams::from_values(0.6, -0.1, 0.55, 90.0, 0.40, -4.0, 0.20),
        hat_open: DrumSlotParams::from_values(0.65, -0.1, 0.55, 420.0, 0.35, -4.0, 0.20),
